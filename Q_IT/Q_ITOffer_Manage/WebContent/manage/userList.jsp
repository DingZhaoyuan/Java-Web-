...
<div class="rightinfo">
  ...
  <jsp:useBean id="pagination" class="com.qst.itofferbacker.javabean.UserPageBean" scope="request">
  ...
  <div class="pagin">
    ...
    <ul class="paginList">
      ...
      <li class="paginItem"><a href="userList.jsp?pageNo=<%=pagination.getTotalPages()+1 %>">下一页<span class="pagenxt"></span></a></li>
       <%} %>
       <li class="paginItem"><a href="userList.jsp?pageNo=<%=pagination.getTotalPages()%>">尾页</a></li>
    </ul>
  </div>
</div>
</body>
